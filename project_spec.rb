...
RSpec.describe Project do  
  before(:each) do 
    @project1 = Project.new('Project 1', 'description 1', 'Mike Brown') # create a new project and make sure we can set the name attribute
    @project2 = Project.new('Project 2', 'description 2', 'Mike Braun')
  end
  ...
  it 'has a getter and seter for owner attribute' do
  ...
  describe "project tasks" do
    it 'has a method add_tasks that pushes the tasks into an array and then returns' do 
